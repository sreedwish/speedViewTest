package com.tocinfotech.speedviewtest
 ...
 */
open class DeluxeSpeedView2 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : Speedometer(context, attrs, defStyleAttr) {
    ...
    override fun defaultGaugeValues() {
        ...
        sections[0].color = 0xFFFFFFFF.toInt()
        sections[1].color = 0xFFFFFFFF.toInt()
        sections[2].color = 0xFFFFFFFF.toInt()
    }
